...
write.csv(updata, "Library/CloudStorage/OneDrive-Nexus365/Documents/GitHub/GitHub_new/ITV/underlying_data/all_inspeections_care_homes.csv")
...
write.csv(updata, "Library/CloudStorage/OneDrive-Nexus365/Documents/GitHub/GitHub_new/ITV/underlying_data/all_inspeections_non_care_homes.csv")
